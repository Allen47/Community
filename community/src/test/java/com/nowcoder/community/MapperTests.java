...
public class MapperTests {
    ...
    public void testInsertLoginTicket(){
        ...
        loginTicket.setUser_id(001);
        loginTicket.setTicket("msq");
    ...
    public void testSelectLoginTicket(){
        LoginTicket loginTicket = loginTicketMapper.selectByTicket("msq");
        System.out.println(loginTicket);


        loginTicketMapper.updateStatus("msq", 1);
        loginTicket = loginTicketMapper.selectByTicket("msq");
        System.out.println(loginTicket);
    }
